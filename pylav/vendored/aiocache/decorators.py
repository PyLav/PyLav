...
from pylav.vendored.aiocache.base import SENTINEL
from pylav.vendored.aiocache.factory import Cache, caches
from pylav.vendored.aiocache.lock import RedLock
...
class cached:
    ...
    def _key_from_args(self, func, args, kwargs):
        ...
        return (func.__module__ or "") + func.__name__ + str(args[1:] if self.noself else args) + str(ordered_kwargs)
