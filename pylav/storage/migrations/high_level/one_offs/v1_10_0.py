...
from pylav.constants.versions import VERSION_0_0_0, VERSION_1_10_0
...
async def migration_v_1_10_0(client: Client, current_version: Version) -> None:
    if current_version >= VERSION_1_10_0 or current_version == VERSION_0_0_0:
        return

    LOGGER.info("Running %s migration", VERSION_1_10_0)
    ...
    yaml_data["server"]["compression"] = NODE_DEFAULT_SETTINGS["server"]["compression"]
