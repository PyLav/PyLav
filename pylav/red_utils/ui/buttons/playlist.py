...
from pylav.red_utils.ui.modals.playlist import PlaylistSaveModal
from pylav.red_utils.ui.selectors.playlist import PlaylistPlaySelector
...
class PlaylistInfoButton(discord.ui.Button):
    ...
    async def callback(self, interaction: InteractionT):
        ...
        from pylav.red_utils.ui.sources.playlist import Base64Source
