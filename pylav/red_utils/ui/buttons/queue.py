...
class EnqueueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: InteractionT):
        ...
        from pylav.red_utils.ui.modals.queue import EnqueueModal
...
class RemoveFromQueueButton(discord.ui.Button):
    ...
    async def callback(self, interaction: InteractionT):
        ...
        from pylav.red_utils.ui.menus.queue import QueuePickerMenu
        from pylav.red_utils.ui.sources.queue import QueuePickerSource
